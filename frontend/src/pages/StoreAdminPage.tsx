...
import { ExternalLink, LayoutGrid, LogOut, PackagePlus, RefreshCw, Save, Search, ShieldCheck } from 'lucide-react';
import { storeApi } from '../services/storeApi';
import type { Category, OrderSummary, Product } from '../types/store';
import '../styles/store.css';

const emptyProduct: Product = { id: '', category_id: '', slug: '', name: '', subtitle: '', description: '', price_cents: 0, original_price_cents: 0, fulfillment: 'digital', delivery_note: '', icon: 'Package', sort_order: 0, active: 1 };
