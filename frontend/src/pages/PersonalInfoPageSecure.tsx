...
export default function PersonalInfoPage() {
        ...
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-black hover:bg-gray-900 disabled:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200"
            >
  ...
  return (
    ...
    <div className={`
      ...
      ${isDark ? 'bg-black border-gray-700' : 'bg-white bg-opacity-30 backdrop-blur-sm border-gray-200'}
      border-r p-6
    `}>
      {isSidebarOpen && (
        <>
        ...
        <div className="mb-6 flex justify-between items-center">
          ...
          >
            <div className={`w-4 h-4 rounded-full transition-transform duration-200 flex items-center justify-center ${
              isDark
                ? 'bg-gray-900 translate-x-6 text-white' 
