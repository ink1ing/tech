    ...
    style={isDark ? {} : {
      ...
      {isMobile && (
        <button
          ...
          className={`fixed top-4 left-4 z-20 p-2 rounded-md active:scale-95 outline-none focus-visible:ring-2 focus-visible:ring-gray-400/40 ${
            isDark ? 'bg-black text-white' : 'glass-light text-black'
          } shadow-md`}
        >
          {isSidebarOpen ? '✕' : '☰'}
        </button>
